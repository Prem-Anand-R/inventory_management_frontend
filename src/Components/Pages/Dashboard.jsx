...
function Dashboard({ setLoggedIn }) {
  ...
  useEffect(() => {
    axios
      .get("https://inventory-api-00rj.onrender.com/totalProductSum")
      .then((res) => {
    ...
    axios
      .get("https://inventory-api-00rj.onrender.com/inwardSum")
      .then((res) => {
    ...
    axios
      .get("https://inventory-api-00rj.onrender.com/outwardSum")
      .then((res) => {
          ...
          <div className="container">
            <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
              ...
              <div className="dropdown text-end">
                ...
                >
                  <img
                    src="https://img.freepik.com/free-vector/businessman-character-avatar-isolated_24877-60111.jpg?w=740&t=st=1704194994~exp=1704195594~hmac=116bc5ebb3af9c46699725dfb0b9d63280ce62bbbbd2f1da6c9940887b12e3e0"
                    alt="mdo"
                    width="32"
                    height="32"
                ...
                <ul className="dropdown-menu text-small">
                  ...
                  >
                    <a className="dropdown-item pointer-event">Sign out</a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="col-lg-9 p-0 col-sm-6">
          ...
          <div className="row mx-3 m-0 p-0 mb-4 ">
            <div className=" col-lg-2 col-sm-12 my-2 mx-3 d-flex justify-content-around  toplist ">
              <div className="p-3  my-2 toplisticon text-success">
                <TbChartArcs />
              </div>
              <div className="p-3">
            ...
            <div className=" col-lg-2 col-sm-12 mx-3 my-2 d-flex justify-content-around  toplist ">
              <div className="p-3  my-2 toplisticon text-danger">
                <TbChartPie />
              </div>
              <div className="p-3">
            ...
            <div className=" col-lg-2 col-sm-12 my-2 mx-2 d-flex justify-content-around   toplist ">
              <div className="p-3  my-2 toplisticon text-primary">
                <IoStatsChart />
              </div>
              <div className="p-3">
          ...
          <div className="chartBar d-flex justify-content-center ">
            <div>
              ...
              <h6 className="text-center mt-3">
                Particular Product Availability
              </h6>
            </div>
          </div>
